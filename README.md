...
A reference fork of [`lmt-ai-19-chatbot`](https://github.com/klodzikowski/lmt-ai-19-chatbot) for Class 20 of the 2 MA LMT *Artificial Intelligence* course at Adam Mickiewicz University. Single static HTML file, no build step. Adds three layers on top of the Class 19 baseline:
...
[klodzikowski.github.io/lmt-ai-20-memory](https://klodzikowski.github.io/lmt-ai-20-memory/). Paste your OpenAI key into Settings, then explore the four drawers: Settings, Memory, Skills, RAG.
...
> *Add the persistent memory, skills, and RAG from `klodzikowski/lmt-ai-20-memory` to my chatbot, but keep my existing design.*

## Licence

CC BY-NC 4.0 (educational and academic use, with attribution; no commercial use). See LICENSE.
